...
const Wishlist = () => {
  ...
  return (
    <div className="container mx-auto px-40 flex flex-col gap-10  w-full items-center justify-between mt-10 py-10">
      <div className="flex flex-col items-center justify-around h-auto w-full gap-8">
        <div className="w-full h-fit flex items-center justify-between py-4 ">
          <p className="text-black font-poppins">{`WishList (${upper.length})`}</p>
          <button className="w-auto px-4 py-2 border rounded-sm">
            Move All To Bag
          </button>
        </div>
