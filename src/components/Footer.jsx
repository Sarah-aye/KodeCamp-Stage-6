...
const Footer = () => {
  return (
    <footer className="bg-black text-white">
      <div className="max-w-7xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 py-14 container w-full mx-auto px-4 sm:px-8 lg:px-40">
        {/* Subscribe */}
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center border border-gray-500 rounded-md px-3 py-2 relative w-full">
              <input
                type="email"
                placeholder="Enter your email"
                className="bg-transparent outline-none flex-1 min-w-0 text-sm placeholder:text-gray-500"
              />
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3 text-gray-400 text-sm">
            ...
            <p className="break-words">exclusive@gmail.com</p>
